...
/***/ "./app/javascript/modules/axios.js":
/*!*****************************************!*\
  !*** ./app/javascript/modules/axios.js ***!
  \*****************************************/
...
axios__WEBPACK_IMPORTED_MODULE_0__["default"].defaults.headers.common['X-CSRF-Token'] = Object(rails_ujs__WEBPACK_IMPORTED_MODULE_2__["csrfToken"])();
/* harmony default export */ __webpack_exports__["default"] = (axios__WEBPACK_IMPORTED_MODULE_0__["default"]);

/***/ }),

/***/ "./app/javascript/modules/handle_favorite.js":
/*!***************************************************!*\
  !*** ./app/javascript/modules/handle_favorite.js ***!
  \***************************************************/
/*! exports provided: listenInactiveFavoriteEvent, listenActiveFavoriteEvent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "listenInactiveFavoriteEvent", function() { return listenInactiveFavoriteEvent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "listenActiveFavoriteEvent", function() { return listenActiveFavoriteEvent; });
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var modules_axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! modules/axios */ "./app/javascript/modules/axios.js");


var listenInactiveFavoriteEvent = function listenInactiveFavoriteEvent(chatId) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.inactive-heart').on('click', function () {
    modules_axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("/chats/".concat(chatId, "/favorite")).then(function (response) {
      if (response.data.status === 'ok') {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.active-heart').removeClass('hidden');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.inactive-heart').addClass('hidden');
      }
    })["catch"](function (e) {
      window.alert('Error');
      console.log(e);
...
var listenActiveFavoriteEvent = function listenActiveFavoriteEvent(chatId) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.active-heart').on('click', function () {
    modules_axios__WEBPACK_IMPORTED_MODULE_1__["default"]["delete"]("/chats/".concat(chatId, "/favorite")).then(function (response) {
      if (response.data.status === 'ok') {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.active-heart').addClass('hidden');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.inactive-heart').removeClass('hidden');
      }
    })["catch"](function (e) {
      window.alert('Error');
      console.log(e);
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var modules_axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! modules/axios */ "./app/javascript/modules/axios.js");
/* harmony import */ var modules_handle_favorite__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! modules/handle_favorite */ "./app/javascript/modules/handle_favorite.js");
...
var handleReplyForm = function handleReplyForm() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show-reply-form').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show-reply-form').addClass('hidden');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.reply-text-area').removeClass('hidden');
  });
};
var appendNewReply = function appendNewReply(reply) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.replies-container').append("\n    <div class=\"chat_reply\">\n      <p>".concat(reply.content, "</p>\n    </div>\n  "));
};
document.addEventListener('DOMContentLoaded', function () {
  ...
  handleReplyForm();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.add-reply-button').on('click', function () {
    var content = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#reply_content').val();
    if (!content) {
      window.alert('返信を入力してください');
    } else {
      modules_axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("/chats/".concat(chatId, "/replies"), {
        reply: {
          content: content
        }
      }).then(function (res) {
        var reply = res.data;
        appendNewReply(reply);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#reply_content').val('');
  ...
  // 「お気に入り」ボタンの状態を表示
  modules_axios__WEBPACK_IMPORTED_MODULE_1__["default"].get("/chats/".concat(chatId, "/favorite")).then(function (response) {
    var hasFavorited = response.data.hasFavorited;
    handleFavoriteDisplay(hasFavorited);
  });
  Object(modules_handle_favorite__WEBPACK_IMPORTED_MODULE_2__["listenInactiveFavoriteEvent"])(chatId);
  Object(modules_handle_favorite__WEBPACK_IMPORTED_MODULE_2__["listenActiveFavoriteEvent"])(chatId);
});
...
var api = __webpack_require__(/*! ../../style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
            var content = __webpack_require__(/*! !../../css-loader/dist/cjs.js??ref--5-1!../../postcss-loader/src??ref--5-2!./trix.css */ "./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/trix/dist/trix.css");
...
/******/ });
//# sourceMappingURL=chat-aa3346146901b194beb7.js.map
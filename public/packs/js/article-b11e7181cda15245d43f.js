...
/*!************************************************!*\
  !*** ./app/javascript/modules/handle_heart.js ***!
  \************************************************/
/*! exports provided: listenInactiveHeratEvent, listenActiveHeratEvent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "listenInactiveHeratEvent", function() { return listenInactiveHeratEvent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "listenActiveHeratEvent", function() { return listenActiveHeratEvent; });
...
var listenInactiveHeratEvent = function listenInactiveHeratEvent(articleId) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.inactive-heart').on('click', function () {
    modules_axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("/articles/".concat(articleId, "/like")).then(function (response) {
...
var listenActiveHeratEvent = function listenActiveHeratEvent(articleId) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.active-heart').on('click', function () {
    modules_axios__WEBPACK_IMPORTED_MODULE_1__["default"]["delete"]("/articles/".concat(articleId, "/like")).then(function (response) {
      if (response.data.status === 'ok') {
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var modules_axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! modules/axios */ "./app/javascript/modules/axios.js");
/* harmony import */ var modules_handle_heart__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! modules/handle_heart */ "./app/javascript/modules/handle_heart.js");
...
var handleCommentForm = function handleCommentForm() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show-comment-form').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show-comment-form').addClass('hidden');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.comment-text-area').removeClass('hidden');
  });
};
var appendNewComment = function appendNewComment(comment) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.comments-container').append("\n    <div class=\"article_comment\">\n      <p>".concat(comment.content, "</p>\n    </div>\n  "));
};
document.addEventListener('DOMContentLoaded', function () {
  ...
  handleCommentForm();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.add-comment-button').on('click', function () {
    var content = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment_content').val();
    if (!content) {
      window.alert('コメントを入力してください');
    } else {
      modules_axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("/articles/".concat(articleId, "/comments"), {
        comment: {
          content: content
        }
      }).then(function (res) {
        ...
        appendNewComment(comment);
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('#comment_content').val('');
  ...
  // 「いいね！」ボタンの状態を表示
  modules_axios__WEBPACK_IMPORTED_MODULE_1__["default"].get("/articles/".concat(articleId, "/like")).then(function (response) {
    var hasLiked = response.data.hasLiked;
    handleHeartDisplay(hasLiked);
  });
  Object(modules_handle_heart__WEBPACK_IMPORTED_MODULE_2__["listenInactiveHeratEvent"])(articleId);
  Object(modules_handle_heart__WEBPACK_IMPORTED_MODULE_2__["listenActiveHeratEvent"])(articleId);
});
...
/******/ });
//# sourceMappingURL=article-b11e7181cda15245d43f.js.map